...
const Profile = () => {
    ...
    useEffect(() => {
        if (
            ...
            axios
                .get(
                    `https://dots.liara.run/api/users/${localStorage.getItem(
                        'username'
                    )}`,
                    {
                        headers: {
        ...
        <div className="wrapper">
            ...
            {user.id ? (
                <div className="profile-data flex gap-5 ">
                    <div className="profile-img overflow-hidden border-2 border-accent-color h-25 w-25 rounded-full bg-white ">
                        <img
